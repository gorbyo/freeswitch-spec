...
%if %{build_mod_amqp}
%package event-amqp
Summary:        AMQP protocol support for the FreeSWITCH open source telephony platform
Group:          System/Libraries
Requires:   %{name} = %{version}-%{release}
...
%if %{build_mod_amqp}
EVENT_HANDLERS_MODULES+=" event_handlers/mod_amqp"
%endif
...
######################################################################################################################
%changelog
* Tue Jan 17 2017 Oleh Horbachov 1.6.14-1.8
- 

* Tue Jan 17 2017 Oleh Horbachov 1.6.14-1.7
- 

* Mon Jan 16 2017 Oleh Horbachov 1.6.14-1.6
- new package built with tito

* Mon Jan 16 2017 Oleh Horbachov 1.6.14-1.5
- 

* Mon Jan 16 2017 Oleh Horbachov 1.6.14-1.4
- 

* Mon Jan 16 2017 Oleh Horbachov 1.6.14-1.3
- 

* Mon Jan 16 2017 Oleh Horbachov 1.6.14-1.2
- 
...
* Mon Jan 16 2017 ohorbachov <gorbyo@gmail.com> 1.6.14-1
- Rebuild 
* Wed Dec 21 2016 Oleh Horbachov <gorbyo@gmail.com> 1.6.13-3.1
- add patch FS-9826 reset jitter buffer if SSRC changes regardless of jitter buffer paused state
* Thu Dec 1 2016 Oleh Horbachov <gorbyo@gmail.com> 1.6.13-2.1
- remove monit file
* Thu Dec 1 2016 Oleh Horbachov <gorbyo@gmail.com> 1.6.13-2
- rebuild
* Thu May 19 2016 Oleh Horbachov <gorbyo@gmail.com> 1.6.8-3
- enable mod_v8 and mod_shout
* Thu May 5 2016 Oleh Horbachov <gorbyo@gmail.com>
- add mod_amqp
